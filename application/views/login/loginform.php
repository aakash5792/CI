  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="/assets/index2.html"><b>Apps</b>Project</a>
      </div><!-- /.login-logo -->
      ...
      <?php echo isset($username_error) ? '<div class="alert-danger">'.$username_error.'</div>' : ''; ?>
...
<?php echo isset($password_error) ? '<div class="alert-danger">'.$password_error.'</div>' : ''; ?>
