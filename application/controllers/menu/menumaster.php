...
class menumaster extends CI_Controller
{
	...
	public function index(){
		$data =$this->common->index('menu_master');
		//echo '<pre>'.print_r($data,true);die();
		$this->load->view($data['url'],$data);
		$this->load->view('footer-links-1',$data);

	}
	public function menumaster_list(){
		$sql_data =$this->common->sql_list('menu_master');
	...
	public function menumaster_action(){
		$data =$this->common->index('menu_master');
	...
	public function menumaster_delete(){
		$data =$this->common->index('menu_master');
