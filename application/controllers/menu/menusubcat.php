...
* 
*/
class menusubcat extends CI_Controller
{
	...
	public function index(){
		$data =$this->common->index('menu_sub_category');
		//echo '<pre>'.print_r($data,true);die();
		$this->load->view($data['url'],$data);
		$this->load->view('footer-links-1',$data);

	}
	public function menusubcat_list(){
		$sql_data =$this->common->sql_list('menu_sub_category');
	...
	public function menusubcat_action(){
		$data =$this->common->index('menu_sub_category');
	...
	public function menusubcat_delete(){
		$data =$this->common->index('menu_sub_category');
