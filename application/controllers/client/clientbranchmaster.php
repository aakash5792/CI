...
*
*/
class clientbranchmaster extends CI_Controller
{
	...
	public function index(){
		$data =$this->common->index('client_branch');
		//echo '<pre>'.print_r($data,true);die();
		$this->load->view($data['url'],$data);
		$this->load->view('footer-links-1',$data);

	}
	public function clientbranchmaster_list(){
		$sql_data =$this->common->sql_list('client_branch');
	...
	public function clientbranchmaster_action(){
		$data =$this->common->index('client_branch');
	...
	public function clientbranchmaster_delete(){
		$data =$this->common->index('client_branch');
