...
class productsubcategory extends CI_Controller
{
	...
	public function productsubcategory_list(){
		$sql_data =$this->common->sql_list('product_sub_category');
	...
	public function productsubcategory_action(){
		$data =$this->common->index('product_sub_category');
	...
	public function productsubcategory_delete(){
		$data =$this->common->index('product_sub_category');
