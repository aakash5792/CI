...
*
*/
class subcenter extends CI_Controller
{
	...
	public function index(){
		$data =$this->common->index('country_subcenter');
		//echo '<pre>'.print_r($data,true);die();
		$this->load->view($data['url'],$data);
		$this->load->view('footer-links-1',$data);

	}
	public function subcenter_list(){
		$sql_data =$this->common->sql_list('country_subcenter');
	...
	public function subcenter_action(){
		$data =$this->common->index('country_subcenter');
	...
	public function subcenter_delete(){
		$data =$this->common->index('country_subcenter');
