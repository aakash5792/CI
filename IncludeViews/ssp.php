...
class ssp {
     ...
     *
     */
    static function simple ( $request, $sql_details, $table,  $columns, $joinQuery = NULL, $extraWhere = '', $groupBy = '')
    {
        $bindings = array();
        ...
        $data = SSP::sql_exec( $db, $bindings,$query);
         ...
         $recordsFiltered = count(SSP::sql_exec( $db,$count_request));
    
         // Total data set length



        $resTotalLength = count(SSP::sql_exec( $db,$count_request));
